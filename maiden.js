...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__extjs_004e483d95f2478a473d1785130809d73d79b8c4": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){function codeMirrorCallback (){if (window.codeMirror){window.codeMirror.on ("change" , function (cm , change){var callback = ($1); callback (cm.getValue ());});}else {window.setTimeout (codeMirrorCallback , 500);}}codeMirrorCallback ();})());
            },
