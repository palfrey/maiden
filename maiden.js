...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            return fetch( "maiden.wasm", {credentials: "same-origin"} )
                .then( function( response ) { return response.arrayBuffer(); } )
                .then( function( bytes ) { return WebAssembly.compile( bytes ); } )
                .then( function( mod ) { return WebAssembly.instantiate( mod, instance.imports ) } )
                .then( function( wasm_instance ) {
                    var exports = instance.initialize( wasm_instance );
                    console.log( "Finished loading Rust wasm module 'maiden'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'maiden':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__extjs_a909f25ee694b57ecf0afcadbeb6db2325d9f99e": function() {
            ...
            "__extjs_32ac83f3d0a91bdc4e7661eaa3041c345505c043": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){function codeMirrorCallback (){if (window.codeMirror){if (! window.codeMirror.configured){window.codeMirror.on ("change" , function (cm , change){var callback = ($1); callback (cm.getValue ());}); window.codeMirror.addKeyMap ({"Cmd-Enter" : function (cm){var callback = ($2); console.log ("Calling run"); callback ();}}); console.log ("setup callback"); window.codeMirror.configured = true ;}}else {window.setTimeout (codeMirrorCallback , 500);}}codeMirrorCallback ();})());
            },
